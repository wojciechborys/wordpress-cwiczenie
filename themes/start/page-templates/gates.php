                    ...
                    <section class="about mt-c mb-c">
                        <div class="container mx-auto">
                            <div class="row mpad">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-lg-6 pr-lg-4 text-justify">
                                            <?php echo get_field('about-left') ?>
                                        </div> 
                                        <div class="col-lg-6 pl-lg-4 text-justify">
                                            <?php echo get_field('about-right') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
